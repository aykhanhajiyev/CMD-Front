(function ($) {
    ...
    $(function () {
        $("#profit-slider-range").slider({
            ...
            max: 100000,
            slide: function (event, ui) {
                $("#profit-amount").val("$" + ui.value); const profit_amount = document.getElementById("profit-amount").value.replace("$","");
                const month_amount = document.getElementById("month-amount").value.replace("Months","");
                document.getElementById("return-amount").textContent="$"+(profit_amount*month_amount/100).toFixed(2);
            }
        });
    ...
    $(function () {
        $("#profit-slider-range-month").slider({
            ...
            slide: function (event, ui) {
                ...
                const profit_amount = document.getElementById("profit-amount").value.replace("$","");
                const month_amount = document.getElementById("month-amount").value.replace("Months","");
                document.getElementById("return-amount").textContent="$"+(profit_amount*month_amount/100).toFixed(2);
            }
        });
